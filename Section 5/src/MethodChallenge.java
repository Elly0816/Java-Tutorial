public class MethodChallenge {
    ...
    public static void main(String[] args) {
        ...
        score = 1000;
        displayHighScorePosition("Chen", calculateHighScorePosition(score));

        score = 500;
        displayHighScorePosition("Nolan", calculateHighScorePosition(score));

        score = 100;
        displayHighScorePosition("Jackson", calculateHighScorePosition(score));

        score = 25;
        displayHighScorePosition("Smitty", calculateHighScorePosition(score));
